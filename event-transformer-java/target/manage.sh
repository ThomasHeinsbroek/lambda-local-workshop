...
FUNCTION_NAME=PtDataPublisherIntervalProducer
HANDLER=io.quarkus.amazon.lambda.runtime.QuarkusStreamHandler::handleRequest
RUNTIME=java11
ZIP_FILE=fileb:///C:/Gitlab_projects/monorepo/apps/vehicle-communication/interval-producer/functions/interval-producer/target/function.zip
...
then
  RUNTIME=provided
  ZIP_FILE=fileb:///C:/Gitlab_projects/monorepo/apps/vehicle-communication/interval-producer/functions/interval-producer/target/function.zip
  FUNCTION_NAME=PtDataPublisherIntervalProducerNative
